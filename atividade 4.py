...
botao_potencia = tk.Button(janela, text="x^2", command=lambda: inserir_texto("x^2"), width=13, height=4, font=("Arial", 12))
botao_potencia.grid(column=4, row=6)
botao_raiz = tk.Button(janela, text="√x", command=lambda: inserir_texto("√x"), width=13, height=4, font=("Arial", 12))
botao_raiz.grid(column=1, row=6)
botao_inverso = tk.Button(janela, text="1/x", command=lambda: inserir_texto("1/x"), width=13, height=4, font=("Arial", 12))
botao_inverso.grid(column=2, row=6)
